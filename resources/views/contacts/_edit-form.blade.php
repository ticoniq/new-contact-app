<div class="row">
    <div class="col-md-12">
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <input type="text" name="first_name" value="{{ $contact->first_name }}" id="first_name" class="form-control @error('first_name') is-invalid @enderror">
          @error('first_name')
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <input type="text" name="last_name" value="{{ $contact->last_name }}" id="last_name" class="form-control @error('last_name') is-invalid @enderror">
          @error('last_name')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
